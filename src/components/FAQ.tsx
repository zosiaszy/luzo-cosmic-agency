...
const FAQ = () => {
  const faqs = [
    {
      question: "Czym różni się LUZO MMA od innych agencji marketingowych?",
    ...
    {
      question: "Jak wygląda proces współpracy z LUZO MMA?",
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">
            <span className="bg-gradient-primary bg-clip-text text-glow animate-fade-in">FAQ</span>
          </h2>
